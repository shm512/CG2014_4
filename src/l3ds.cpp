...
LColor3 LMaterial::GetAmbientColor() const
{
    return m_ambient;
}

LColor3 LMaterial::GetDiffuseColor() const
{
    return m_diffuse;
}

LColor3 LMaterial::GetSpecularColor() const
{
    return m_specular;
}

float LMaterial::GetShininess() const
{
    return m_shininess;
}
